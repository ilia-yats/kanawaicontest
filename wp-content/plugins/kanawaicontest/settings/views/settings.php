<div class="wrap">
    ...
    <!--                           value=" -->
    <?php //echo sanitize_text_field($bookingmanager_admin_email); ?><!--"/>-->
    <!--                </td>-->
    <!--            </tr>-->
    <!--            <tr valign="top">-->
    ...
    <!--                           value=" -->
    <?php //echo sanitize_text_field(get_option('bookingmanager_client_email_subject')); ?><!--"/>-->
    <!--                </td>-->
    <!--            </tr>-->
    <!--            <tr valign="top">-->
    <!--                <th scope="row">-->
    ...
    <!--                    <p><i>(считается автоматически добавлением -->
    <?php //echo BOOKINGMANAGER_RESERVE_EXPIRE_HOURS; ?><!-- часов ко времени бронирования)</i></p>-->
