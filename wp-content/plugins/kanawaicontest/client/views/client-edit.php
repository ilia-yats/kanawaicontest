<div class="wrap">
    <h1>Редактирование записи о клиенте</h1>

    <?php $item = $this->client_obj->get_client($id); ?>
    ...
    <form action="" method="post">
        <table class="form-table">
            ...
            <tr class="row-is_blacklisted">
                ...
                <td>
                    <input type="checkbox" name="is_blacklisted" id="is_blacklisted" <? if($item->is_blacklisted == 1) echo 'checked'; ?> style="margin-right:10px;"/>
                </td>
            </tr>
            </tbody>
        </table>
